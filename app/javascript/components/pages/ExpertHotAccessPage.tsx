      ...
      <section className="expert-hot-scroll" aria-label="Aulas Completas">
        <div className="expert-hot-content">
          <article className="expert-hot-copy">
            ...
            <p>
              <strong>Spoiler:</strong> Você terá acesso à nossa plataforma própria e exclusiva para rodar sua operação
          ...
          <div className="expert-hot-media" aria-hidden="true">
            <img src="/source-six-assets/tday6unoazs5ho4srfet3wlbuhi6-0f7579313d9c.png" alt="" />
          </div>
        </div>
      </section>
    </main>
