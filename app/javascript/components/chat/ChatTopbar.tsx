...
const avatars = {
  night: "/source-six-assets/Cindy.jpeg-33fa075ae954.jpg",
  livy: "/source-six-assets/d0f92b7a6b87e4692dfd1c8e88c5df4e-3a8ff1ea6fcf.jpg",
  lulu: "/source-six-assets/IMG_7929.jpeg-ecc736f53778.jpg",
  cabritinho: "/source-six-assets/photo_2025-12-05_16-06-52-9c0423940f33.jpg",
};
  ...
  return (
    <header className="chat-topbar" ref={topbarRef}>
      <div className="chat-brand">
        <img className="p6-logo" src="/source-six-assets/rji72k58i9o4ujxgb0n0wqpf12pf-b4d4c257bd35.png" alt="Project Six" />
        <ChevronDown size={15} />
      </div>
      ...
      <nav className="chat-nav" aria-label="Navegação principal">
        {nav.map((item) => (
          <button
            className={`p6-nav-pill ${navItemIsActive(item, activeView) ? "active" : ""}`}
            key={item}
            type="button"
            onClick={() => {
...
function DmAgents() {
  const agents = [
    ...
    { name: "Cabritinho", avatar: avatars.cabritinho, text: "Olá, sou o cabritinho e estou aqui para te guiar no Project Six" },
  ];
